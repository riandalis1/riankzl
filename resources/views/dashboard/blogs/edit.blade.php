...
@section('container')
    <h1 class="text-white text-center text-md md:text-xl lg:text-2xl mb-4 font-semibold">
        Edit <span class="text-cyan-500">blog</span>
    </h1>
    ...
    <div
        ...
        <div
            ...
            <form class="mx-auto" method="post" action="/dashboard/blogs/{{ $blog->slug }}" enctype="multipart/form-data">
                @method('put')
                @csrf
                <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                    <div class="sm:col-span-2">
                        ...
                        <input type="text" name="title" id="title"
                            ...
                            placeholder="Title name" value="{{ old('title', $blog->title) }}">
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <input type="text" name="slug" id="slug"
                            ...
                            placeholder="Slug must be unique" value="{{ old('slug', $blog->slug) }}">
                    ...
                    <div class="sm:col-span-1">
                        @if ($blog->image)
                            <img src="{{ asset('storage/' . $blog->image) }}" class="img-preview w-full rounded">
                        @else
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <textarea id="body" rows="5"
                            ...
                            placeholder="Write your thoughts here..." name="body">{{ old('body', $blog->body) }}</textarea>
